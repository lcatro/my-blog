...
public class XposedHelpers {
	 ...
	 * <p>A {@link com.tencent.kingkong.xposed.XposedHelpers.ClassNotFoundError} is thrown in case the class was not found.
	 */
	...
	public static XC_MethodHook.Unhook findAndHookMethod(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
		...
		try {
			...
			unhook = XposedBridge.hookMethod(m, callback);
		} catch (Exception e) {
			Log.d("XposedHelpers", android.util.Log.getStackTraceString(e));
		} catch (Error e) {
			Log.d("XposedHelpers", android.util.Log.getStackTraceString(e));
		}
		return unhook;
...
//	}
	...
	public static Object removeAdditionalInstanceField(Object obj, String key) { if (obj == null)
			throw new NullPointerException("object must not be null");
		if (key == null)
			throw new NullPointerException("key must not be null");
